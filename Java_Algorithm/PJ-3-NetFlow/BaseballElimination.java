...
public class BaseballElimination
{
  ...
  private FlowNetwork generateFlow(int id)
  {
  ...
  public boolean isEliminated(String team)
  {
	 ...
	 if (teamList.get(tid).wins + teamList.get(tid).remaining < maxWins) return true;
  ...
  public Iterable<String> certificateOfElimination(String team)
  {
     ...
     int tid = team2id.get(team);
	 if (teamList.get(tid).wins + teamList.get(tid).remaining < maxWins)
	 {
	   vertices.add(teamList.get(maxID).team);
	   return vertices;
	 }
